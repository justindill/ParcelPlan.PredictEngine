...
{
    public class CostPredictionUnit
    {
        [LoadColumn(0)]
        ...
        public static CostPredictionUnit FromCsv(string csvLine)
        {
            string[] values = csvLine.Split(',');

            CostPredictionUnit predictionUnit = new CostPredictionUnit();

            predictionUnit.Id = values[0];
            predictionUnit.CarrierServiceName = values[1];
            predictionUnit.ShipDay = values[2];
            ...
            predictionUnit.TotalCost = float.Parse(values[6]);
            predictionUnit.AreaSurchargesNone = values[7];
            predictionUnit.AreaSurchargesDelivery = values[8];
            predictionUnit.AreaSurchargesExtended = values[9];
            predictionUnit.AreaSurchargesRemote = values[10];
